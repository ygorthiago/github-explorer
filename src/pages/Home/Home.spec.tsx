...
describe('Home Page', () => {
  ...
  it('should be able to search a repository', () => {
    ...
    fireEvent.change(searchRepositoryInput, {
      target: { value: 'repository/test-search' },
    });
  ...
  it('should not be able to search a repository without filling the search input', () => {
    ...
    expect(searchErrorMessage).toHaveTextContent(
      'Enter the author/repository name',
    );
  });
  ...
  it('should display an error if search fails', () => {
    ...
    fireEvent.change(searchRepositoryInput, {
      target: { value: 'repository/test-fails' },
    });
    fireEvent.click(searchRepositoryButton);
  ...
  it('should display an error if repository was not found', () => {
    ...
    fireEvent.change(searchRepositoryInput, {
      target: { value: 'repository/test-not-found' },
    });
    fireEvent.click(searchRepositoryButton);
  ...
  it('should be able to clear repositories list', async () => {
    ...
    const clearRepositoryListButton = getByTestId(
      'clear-repository-list-button',
    );
